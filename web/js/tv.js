/* DZSlides */
  ...
  function init() {
    ...
    var timerDefiler = setInterval(Dz.defiler.bind(Dz), 15000);
  }
...
var timerRechargement = setInterval(rechargement, 900000);
...
source.addEventListener('alarme', function(e) {
    /*clearInterval(timerRechargement);
    clearInterval(timerDefiler);
    setInterval(rechargement, 1800000);*/
}, false);
